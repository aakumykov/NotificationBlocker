 ...
 */
fun CreationExtras.database(): NotificationBlockerApplication = (this[ViewModelProvider.AndroidViewModelFactory.APPLICATION_KEY] as NotificationBlockerApplication)